...
LABEL version=1.0
LABEL description="Phrases microservice"
LABEL vendor="Nicolas"
COPY --from=builder /microservice/target/phrases-0.0.1-SNAPSHOT.jar /opt/phrases-microservice.jar
CMD java -jar /opt/phrases-microservice.jar